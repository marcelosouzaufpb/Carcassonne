...
public class CidadeTeste extends JogoTest {
	...
	/**
	 * Caso de Teste 01 Posicionar um Meeple em uma Cidade.
	 * 
	...
	/**
	 * Caso de teste 02 Cidade com 2 tiles e um meeple cidade.
	 *
	...
	public void cidaeComDoisTilesMeeple() {
		...
		verificarRelatorioTurno(partida, "VERMELHO", "11SE", "MEEPLE_POSICIONADO");
		partida.finalizarTurno();
	...
	/**
	 * Caso de tese 04 Verificar cidades antes e depois de colocar um Meeple em uma
	 * cidade.
	 * 
	...
	/**
	 * Caso de teste 05 Jogador com varias cidades
	 * 
	...
	public void jogadorComDuasCidades() {
		...
		Assert.assertEquals("11(NO,NE) 11(SO-VERMELHO,SE) 30(NO-AMARELO,NE) 64(NO-VERMELHOR,NE))",partida.getCidades());
		verificarRelatorioTabuleiro(partida, "11S\n30L64L39N");
	}
	...
	/**
	 * Caso de teste 07 Cidade em formato de L.
	 */
	@Test
	...
	/**
	 * Caso de teste 08 Cidade em formato de Cruz.
	 */
	...
	public void cidadeEmFormatoCruz() {
		...
		verificarRelatorioPartida(partida, "Partida_Finalizada", "AMARELO(0,7); VERMELHOR(0,7);");
		Assert.assertEquals(
				"01(NO-AMARELO,NE) 11(NE,SE) 11(SE,SO) 11(SO,NO) 19(NO,SE) 20(SO,NO) 21(NO,NE) 22(NE,SE) ",
				partida.getCidades());
	...
	/**
	 * Caso de teste 09 Fim de partida com cidade aberta;
	 */
	...
	public void fimdDePartidaComCidadeAberta() {
		...
		Assert.assertEquals("11(NO-AMARELO,NE) 11(SO-VERMELHO,SE) 42(NO,NE) 42(SO,SE)",
				partida.getCidades());
		verificarRelatorioTabuleiro(partida, "11S\n42N");
	}

	/**
	 * Caso de teste 10 Pontuacao para uma cidade com empate de meeples dos
	 * jogadores
	 */
	@Test
	...
	/**
	 * Caso de teste 11 Pontuacao para uma cidade onde um dos jogadores tem mais
	...
	/**
	 * Caso de teste 12 Duas cidades separadas cada uma pertence a um jogador mas
	...
	public void cidadesSeparadasQueSeEncontram() {
		...
		Assert.assertEquals(
				"34(SO,SE) 34(NE,SE) 14(NO,SO) 14(SO,SE) 30(NO-AMARELO,NE) 24(NO-VERMELHO,NE)",
				partida.getCidades());
		verificarRelatorioTabuleiro(partida, "34S14S\n30N24O");
	}

	/**
	 * Caso de teste 13 Partida com 3 Jogadores
	 */
	public void partidaCom3Jogadores() {
		...
		Assert.assertEquals(
				"30(NO-AMARELO,NE) 24(NO-VERMELHO,NE) 08(NO-PRETO,SO) 08(SO-PRETO,SE) 08(SE-PRETO,NE)",
				partida.getCidades());
	...
	/**
	 * Caso de teste 14 Partida com 4 Jogadores.
	 */
	...
	/**
	 * Caso de teste 15 Partida cidade mista e 4 jogadores.
	 */
	...
	public void partidaCom4JogadoreCidadeMista() {
		...
		Assert.assertEquals(
				"30(NO-AMARELO,NE) 24(NO-VERMELHO,NE) 08(NO-PRETO,SO) 08(SO-PRETO,SE) 08(SE-PRETO,NE) 36(NO-AZUL,NE) 14(NO,SO) 14(SO,SE) 31(SO,SE) 31(SE,NE)",
				partida.getCidades());
